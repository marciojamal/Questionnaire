 ...
 * @version 1.0
 */
public abstract class AdminBaseBean implements Serializable {

	private Administrator userLoggedBean;
	...
	public AdminBaseBean() {
		super();
	}
	
	
	public Administrator getUserLogged(){
		if(userLoggedBean==null){
			userLoggedBean = new Administrator();
			userLoggedBean.setId(1);
		}
		return userLoggedBean;
	}
	...
	protected void displayInfoMessage(String message) {
        FacesMessage fMessage = new FacesMessage(FacesMessage.SEVERITY_INFO, "Atenção", message);
	...
	protected void displayErrorMessage(String message) {
        ...
        FacesMessage fMessage = new FacesMessage(FacesMessage.SEVERITY_ERROR, "Atenção", message);
        FacesContext.getCurrentInstance().addMessage(null, fMessage);
    }
